...
DROP POLICY IF EXISTS "Coaches can manage all roles" ON public.user_roles;
DROP POLICY IF EXISTS "Dealers can view their own actions" ON public.actions;
DROP POLICY IF EXISTS "Dealers can create actions for their dealership" ON public.actions;
DROP POLICY IF EXISTS "Dealers can update their own actions" ON public.actions;
DROP POLICY IF EXISTS "Coaches can delete any action" ON public.actions;
