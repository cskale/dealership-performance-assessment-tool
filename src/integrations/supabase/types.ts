  ...
  public: {
    Tables: {
      ...
      visit_action_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "visit_action_reviews_action_id_fkey"
            columns: ["action_id"]
            isOneToOne: false
            referencedRelation: "improvement_actions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "visit_action_reviews_visit_id_fkey"
            columns: ["visit_id"]
            isOneToOne: false
            referencedRelation: "coach_visits"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_network_coaching_stats: {
        Args: never
        Returns: {
          agreed_actions: number
          agreed_actions_completed: number
          agreed_completion_rate: number
