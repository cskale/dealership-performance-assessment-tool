...
const de: Record<string, string> = {
  ...
  'maturity.performing': 'Leistungsstark',
  ...
  'maturity.performingDesc': 'Konsistente Ausführung mit datengesteuertem Management',
  'maturity.advancedDesc': 'Marktdifferenzierende Leistung und kontinuierliche Verbesserung',
  ...
  'actionPlan.all': 'Alle',
  'actionPlan.done': 'Erledigt',
  'actionPlan.overdue': 'Überfällig',
  'actionPlan.actionsComplete': '{completed} von {total} erledigt',
  'actionPlan.search': 'Maßnahmen suchen...',
  'actionPlan.list': 'Liste',
  'actionPlan.kanban': 'Kanban',
  'actionPlan.roadmap': 'Roadmap',
  'actionPlan.filter': 'Filter',
  'actionPlan.sort': 'Sortieren',
  'actionPlan.dueDate': 'Fälligkeitsdatum',
  'actionPlan.triageScore': 'Triage-Wert',
  'actionPlan.loadMore': 'Weitere Maßnahmen laden',
  'actionPlan.loading': 'Maßnahmenplan wird geladen...',
  'actionPlan.viewOnly': 'Maßnahmen werden schreibgeschützt angezeigt.',
  'actionPlan.noActionsShort': 'Keine Maßnahmen gefunden',
  'actionPlan.noActionsHelp': 'Generieren Sie Maßnahmen aus Ihrer Bewertung oder fügen Sie sie manuell hinzu.',
  'actionPlan.noPhaseActions': 'Noch keine Maßnahmen in dieser Phase',
  'actionPlan.quickWin': 'Schneller Erfolg',
  'actionPlan.fromCoachingVisit': 'Aus Coaching-Besuch',
  'actionPlan.fieldNotes': 'Feldnotizen für diese Abteilung verfügbar',
  'actionPlan.viewKpi': 'KPI anzeigen',
  'actionPlan.milestone25': 'Guter Start — 25 % erledigt. Konsequenz führt jetzt zu weiteren Verbesserungen.',
  'actionPlan.milestone50': 'Die Hälfte ist geschafft. Halten Sie den Schwung für weitere Verbesserungen.',
  'actionPlan.milestone75': '75 % erledigt — ausgezeichnetes Tempo. Bewerten Sie die verbleibenden Maßnahmen neu.',
  'actionPlan.milestone100': 'Alle Maßnahmen erledigt — bereit für Ihre nächste Bewertung.',
  'actionPlan.scheduleReassessment': 'Neubewertung planen',
  'actionPlan.dismissMilestone': 'Hinweis schließen',
  'actionPlan.markedComplete': 'Maßnahme als erledigt markiert',
  'actionPlan.updateStatusFailed': 'Status konnte nicht aktualisiert werden',
  'actionPlan.roadmapQuick': 'Schnelle Erfolge (0–30 Tage)',
  'actionPlan.roadmapProcess': 'Prozessänderungen (31–60 Tage)',
  'actionPlan.roadmapGovernance': 'Steuerung & Systeme (61–90 Tage)',
  ...
  'kpi.invalidRange': 'Geben Sie eine Zahl zwischen {min} und {max} ein.',
};
